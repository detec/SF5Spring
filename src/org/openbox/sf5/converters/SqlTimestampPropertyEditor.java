...
public class SqlTimestampPropertyEditor extends PropertyEditorSupport {
	...
	/**
	 * * Uses the given pattern for dateparsing, see {@link SimpleDateFormat}
	 * for allowed patterns. * * @param pattern * the pattern describing the
	 * date and time format * @see SimpleDateFormat#SimpleDateFormat(String)
	 */
